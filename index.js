const { Client, Intents, MessageButton, IntentsBitField, NoSubscriberBehavior, DiscordAPIError, MessageSelectMenu, MessageAttachment, MessageEmbed, MessageActionRow, Modal, TextInputComponent } = require('discord.js');
...
client.on('interactionCreate', async interaction => {
  if (interaction.customId === "ticketpanel"){
    if (interaction.values[0] === 'ticket_1'){
      const modal = new Modal()
        .setCustomId('heyeheheh')
        .setTitle('Buy Robux');
